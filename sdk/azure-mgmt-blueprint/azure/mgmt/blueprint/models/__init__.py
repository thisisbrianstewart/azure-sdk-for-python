...
try:
    ...
    from ._models_py3 import ParameterValueBase
    ...
    from ._models_py3 import SecretReferenceParameterValue
    ...
    from ._models import ParameterValueBase
    ...
    from ._models import SecretReferenceParameterValue
